...
\blockzitat{Das ist ein Blockzitat. Damit der das Blockzitat enthaltenen Absatz korrekt angezeigt wird, muss das Blockzitat im tex-Dokument von leeren Zeilen umrahmt sein. Blockzitate sind direkte Zitate, die im Fließtext *mehr als drei Zeilen* [Hervorhebung M.M.] einnähmen. Blockzitate stehen nicht in Anführungszeichen. Der Nachweis erfolgt im Anschluss an das Zitat. Sie müssen in Ihrem Fließtext auf das Blockzitat eingehen, es problematisieren oder interpretieren. Das Blockzitat steht niemals für sich und ersetzt nie Ihren eigenen Beitrag. [MusBlock 96]}

Nach dem Blockzitat geht es mit einem Text ohne Einzug weiter. Kapitel enden nie mit einem Blockzitat.

Dieser Absatz demonstriert ein Zitat mit kanonischer Zitierweise: "Es ist überall nichts in der Welt, ja überhaupt auch außer derselben zu denken möglich, was ohne Einschränkung für gut könnte gehalten werden, als allein ein guter Wille" [GMS 393]. Manche glauben, Kant sei außerdem der Meinung, dass dieser Satz indirekte Zitate mit Siglum demonstriert [GMS 123456789].
